...
def TagConfig():
    #Keyword colors
    textPad.tag_config("Token.Keyword.Declaration",foreground="medium blue");
    textPad.tag_config("Token.Literal.String",foreground="royal blue");
    textPad.tag_config("Token.Literal.String.Char",foreground="steel blue");
    textPad.tag_config("Token.Keyword.Namespace",foreground="dark slate gray");
    textPad.tag_config("Token.Comment.Single",foreground="gray47");
    textPad.tag_config("Token.Literal.Number.Integer",foreground="red4");
    textPad.tag_config("Token.Literal.Number.Float",foreground="red3");
    textPad.tag_config("Token.Literal.Number.Double",foreground="red3");
    textPad.tag_config("Token.Keyword.Type",foreground="DodgerBlue2");
...
def SaveAs():
    ...
    p = tkFileDialog.asksaveasfilename(defaultextension=".go",filetypes=types);
...
def Highlight():
    ...
    for token, content in lex(data, GoLexer()):
...
root = Tk(); #Main window
root.title("Go Simple Editor"); #The title of main window
root.iconbitmap('icon.ico'); #The icon of main window

#Create the text field
textPad = Text(root, bg="papaya whip",
               wrap=NONE, undo=True, width=70, height=43.75);
